...
export type IssueParentLookupQuery = {
  __typename?: "Query"
  node?:
    ...
    | { __typename?: "Issue"; id: string; parent?: { __typename?: "Issue"; id: string } | null }
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    IssueParentLookup(
      variables: IssueParentLookupQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"],
    ): Promise<IssueParentLookupQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<IssueParentLookupQuery>({
